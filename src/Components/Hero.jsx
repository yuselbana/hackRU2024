    ...
    return (
        <div id="home" className="grid min-h-screen grid-rows-3 grid-cols-2 place-items-center">
            <div className='row-start-1 text-center row-end-3 col-span-full'>
                <h3 className='text-6xl font-bold'>empowering tomorrow&apos;s food today.</h3>
            </div>
        

            <PingLocation/>
            
            <div className='w-full  md:row-start-2 row-start-3 row-end-4 col-start-1 col-end-3 flex justify-around items-center '>
